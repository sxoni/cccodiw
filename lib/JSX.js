...
(function() {
    ...
    var __dirname = (function() {
        ...
        // Convert it to a user directory relative path, not an absolute system path -- as for some reason we couldn't access the file
        // if (isMac) {
        //     let start = path.indexOf("/Library")
        ...
        if (forceEval) {
            ...
            jsxScript = (
                ...
                [
                    ...
                    "        ErrorMessage = 'EvalScript error: ' + name + ' ' + e.number + ': ' + description;",
