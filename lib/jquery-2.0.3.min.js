                ...
                (c = ot.setDocument = function (e) {
                    ...
                    return t !== p && 9 === t.nodeType && t.documentElement
                        ? ((p = t),
                          ...
                          (n.matchesSelector = Q.test((m = f.webkitMatchesSelector || f.mozMatchesSelector || f.oMatchesSelector || f.msMatchesSelector))) &&
                              ut(function (e) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            ...
                            return J.CHILD.test(e[0])
                                ? null
                                : (e[3] && e[4] !== undefined ? (e[2] = e[4]) : n && V.test(n) && (t = gt(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                        },
                    },
                    filter: {
                        TAG: function (e) {
            ...
            attr: function (e, t, n) {
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return typeof e.getAttribute === r
                        ? x.prop(e, t, n)
                        : ((1 === s && x.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = x.attrHooks[t] || (x.expr.match.bool.test(t) ? M : R))),
                          n === undefined
    ...
    (x.event = {
                ...
                while (c--)
                    (u = X.exec(t[c]) || []),
                        ...
                        d &&
                            ...
                            (f = x.event.special[d] || {}),
                            (p = x.extend({ type: d, origType: m, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && x.expr.match.needsContext.test(o), namespace: g.join(".") }, s)),
                            (h = l[d]) || ((h = l[d] = []), (h.delegateCount = 0), (f.setup && f.setup.call(e, i, g, a) !== !1) || (e.addEventListener && e.addEventListener(d, a, !1))),
                        ...
                        while (o--)
                            (c = f[o]),
                                (!i && g !== c.origType) ||
                                    ...
                                    (f.splice(o, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(e, c));
            ...
            if (
                ...
                return (
                    ...
                    i ||
                        ...
                        !x.acceptData(r) ||
                        (c && x.isFunction(r[d]) && !x.isWindow(r) && ((u = r[c]), u && (r[c] = null), (x.event.triggered = d), r[d](), (x.event.triggered = undefined), u && (r[c] = u))),
                    t.result
                );
            }
        },
                ...
                while ((i = s[t++]) && !e.isPropagationStopped()) {
                    ...
                    while ((o = i.handlers[n++]) && !e.isImmediatePropagationStopped())
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ((e.handleObj = o), (e.data = o.data), (r = ((x.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)), r !== undefined && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
                }
        ...
        (x.Event = function (e, t) {
            return this instanceof x.Event
                ? (e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (e.getPreventDefault && e.getPreventDefault()) ? U : Y)) : (this.type = e),
                  t && x.extend(this, t),
    ...
    (ct.optgroup = ct.option),
        ...
        x.extend({
            clone: function (e, t, n) {
                ...
                if (t)
                    if (n) for (o = o || mt(e), s = s || mt(a), r = 0, i = o.length; i > r; r++) gt(o[r], s[r]);
                    else gt(e, a);
                    ...
                    return (
                        ...
                        n === undefined
                            ? s && "get" in s && (i = s.get(e, !1, r)) !== undefined
                                ...
                                : u[t]
                            : ((o = typeof n),
                              "string" === o && (i = kt.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(x.css(e, t))), (o = "number")),
                              null == n ||
                                  ("number" === o && isNaN(n)) ||
        ...
        (vt = function (e, t, n) {
            ...
            return (
                s &&
                    ...
                    Ct.test(a) && wt.test(t) && ((r = u.width), (i = u.minWidth), (o = u.maxWidth), (u.minWidth = u.maxWidth = u.width = a), (a = s.width), (u.width = r), (u.minWidth = i), (u.maxWidth = o))),
                a
            );
        });
    function Ot(e, t, n) {
    ...
    function Rt(e) {
        ...
        return (
            n ||
                ((n = Mt(e, t)),
                ("none" !== n && n) ||
                    ((xt = (xt || x("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement)),
            ...
            ajax: function (e, t) {
                ...
                if (
                    ...
                    (c.dataTypes = x
                        ...
                        .match(w) || [""]),
                    null == c.crossDomain &&
                        ((a = tn.exec(c.url.toLowerCase())), (c.crossDomain = !(!a || (a[1] === Xt[1] && a[2] === Xt[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (Xt[3] || ("http:" === Xt[1] ? "80" : "443")))))),
                ...
                function k(e, t, o, a) {
                    ...
                    2 !== v &&
                        ...
                        (b = fn(c, b, T, l)),
                        l
                            ? (c.ifModified && ((w = T.getResponseHeader("Last-Modified")), w && (x.lastModified[r] = w), (w = T.getResponseHeader("etag")), w && (x.etag[r] = w)),
                              204 === e || "HEAD" === c.type ? (C = "nocontent") : 304 === e ? (C = "notmodified") : ((C = b.state), (m = b.data), (y = b.error), (l = !y)))
                              ...
                              return function () {
                                  t &&
                                      ...
                                      "abort" === e
                                          ...
                                          : r(mn[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? { text: s.responseText } : undefined, s.getAllResponseHeaders()));
                              };
                          }),
                              (s.onload = t()),
                              (s.onerror = t("error")),
    ...
    x.each({ slideDown: qn("show"), slideUp: qn("hide"), slideToggle: qn("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
        ...
        (x.fn.offset = function (e) {
            ...
            if (s)
                return (
                    (t = s.documentElement),
                    x.contains(t, i) ? (typeof i.getBoundingClientRect !== r && (o = i.getBoundingClientRect()), (n = Hn(s)), { top: o.top + n.pageYOffset - t.clientTop, left: o.left + n.pageXOffset - t.clientLeft }) : o
                );
        }),
        (x.offset = {
                ...
                if (this[0]) {
                    ...
                    return (
                        "fixed" === x.css(n, "position")
                            ...
                            : ((e = this.offsetParent()), (t = this.offset()), x.nodeName(e[0], "html") || (r = e.offset()), (r.top += x.css(e[0], "borderTopWidth", !0)), (r.left += x.css(e[0], "borderLeftWidth", !0))),
